...
class App extends Component {
  ...
  componentDidMount = () => {
    ...
    if(token){
      fetch("https://lmskokua.herokuapp.com/api/v1/auto_login",{
      headers: {
    ...
    fetch(`https://lmskokua.herokuapp.com/api/v1/subjects`)
    .then(resp => resp.json())
    .then(data => this.props.setSubjects(data))

    fetch(`https://lmskokua.herokuapp.com/api/v1/courses`)
    .then(resp => resp.json())
    .then(data => {
      // console.log(data)
