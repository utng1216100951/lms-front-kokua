...
class EditAnnouncementForm extends Component {
    ...
    handleOnSubmit = (e) => {
        ...
        e.preventDefault();
        fetch(`https://lmskokua.herokuapp.com/api/v1/courses/${this.props.url}/announcements/${this.state.id}`,{
            method: "PUT",
            headers: {
        ...
        return (
            <div className="ui segment">
                ...
                <div className="field">
                    ...
                    <MDBBtn gradient="aqua" type="submit" value="Edit Announcement" className="ui submit button">Edit Announcement</MDBBtn>
            </form>
            </div>
